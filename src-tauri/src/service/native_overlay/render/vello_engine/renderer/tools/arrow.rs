...
impl VelloToolRenderer for ArrowRenderer {
    fn render(&self, ctx: &mut VelloRenderContext, obj: &DrawingObject) {
        ...
        let head_width = obj.head_width.unwrap_or(head_len as f32 * 0.82) as f64; // Narrower
        let wing_dist = head_len;
        let neck_dist = head_len * 0.75; // Deeper
        let neck_width = stroke_width * 2.5 + 8.0; // Wider
